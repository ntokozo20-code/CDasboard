...
function Sidebar({ isOpen, setIsOpen }) {
  return (
    <>
      ...
      <aside className={`w-64 bg-white border-r min-h-screen p-4 fixed md:relative z-50 transform transition-transform duration-300 ${
        ...
        <nav className="space-y-4">
          ...
          <div className="flex items-center gap-3 text-gray-500 hover:text-purple-600 cursor-pointer transition">
            <FaChartLine />
            <p>Chart</p>
          </div>
