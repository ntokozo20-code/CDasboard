...
function Sidebar() {
  ...
  <nav className="space-y-4">
    <p className="text-purple-600 font-semibold">Overview</p>
    <p className="text-gray-500">Chart</p>
    <p className="text-gray-500">Transactions</p>
    <p className="text-gray-500">Wallet</p>
    <p className="text-gray-500">Mail Box</p>
